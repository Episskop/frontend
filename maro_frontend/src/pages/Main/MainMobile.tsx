...
import PopupQuizMobile from './popUpQuizMobile'
import HousingDetailsMobile from '../HousingDetailsMobile'
import DropDownMenuMobile from '@/components/DropDownMenu/DropDownMenuMobile'
